...
void calibrate_Ge_4438_no_bg_sub(const string &inData, const string &inBkg, TString detName, TString calibSource){
  ...
  h1->Write();
  TString pdfName = "pdf_results/" + detName + "_Calibration_with_"+ calibSource + "_" + inData.substr(inData.find_last_of('/') + 1) + "_w_bkg.pdf";
  ...
  TString rootName = "pdf_results/" + detName + "_Calibration_with_"+ calibSource + "_" + inData.substr(inData.find_last_of('/') + 1) + "_w_bkg.root";
